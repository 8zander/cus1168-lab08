...
public class InsuranceRatingEngine {
    ...
    private String determineVehicleCategory(DriverProfile profile) {
        ...
        if (make.matches("bmw|mercedes|lexus|audi")) {
            return "luxury";
        } else if (make.matches("ferrari|porsche|mustang|corvette")) {
            return "sports";
        } else if (model.matches("suv|explorer|tahoe|highlander")) {
            return "suv";
        }
        return "sedan";
    }
    ...
    static class Rule {
        ...
        public Rule(String name, 
                   Predicate<DriverProfile> condition,
